  ...
  return (
    <div className="bg-[url('../../public/images/hero-image.png')] bg-cover py-[100px]">
      <h1
        ...
        className="text-white text-[32pt] sm:text-[45pt] text-center container mx-auto w-[90%] my-6 bg-[#242323] bg-opacity-40 rounded-2xl p-6 sm:bg-opacity-0 sm:leading-[4rem]"
      >
